    ...
    <div class="container">
      ...
      <div class="docs-section">
        <div class="docs-header" id="content">
          <h4><strong class="text-muted">test/fixtures/pages/gist-helper.hbs</strong> &#x2192; <strong class="text-success">test/actual/collections/custom/gist-helper.html</strong></h4>
        </div>
        <hr>
      </div>
        ...
        <div class="col-md-9" role="main">
          <div class="docs-section">
            <div class="docs-header" id="content">
              ...
              <h4><strong>Page dest:</strong> test/actual/collections/custom/gist-helper.html</h4>
