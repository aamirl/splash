    ...
    <div class="container">
      ...
      <div class="docs-section">
        <div class="docs-header" id="content">
          <h4><strong class="text-muted">test/fixtures/pages/gist-helper.hbs</strong> &#x2192; <strong class="text-success">test/actual/collections/complex/gist-helper.html</strong></h4>
        </div>
        <hr>
      </div>
        ...
        <div class="col-md-9" role="main">
          <div class="docs-section">
            <div class="docs-header" id="content">
              ...
              <h4><strong>Page src:</strong> test/fixtures/pages/gist-helper.hbs</h4>
              <h4><strong>Page dest:</strong> test/actual/collections/complex/gist-helper.html</h4>
              <h4><strong>Dest filename:</strong> gist-helper.html</h4>
              <h4><strong>Dest basename:</strong> gist-helper</h4>
              <h4><strong>Page title:</strong> Gist Helper</h4>
            </div>
